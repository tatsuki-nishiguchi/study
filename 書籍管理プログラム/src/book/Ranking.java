...
//		setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
		...
		btnNewButton_4 = new JButton("検索画面に戻る");
		btnNewButton_4.setBounds(12, 261, 183, 21);
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				try {
					...
					//SQL文作成
					String mySql ="select * from lendinghistory inner join book on lendinghistory.book_id = book.id order by lendinghistory.valuate desc;";
					//ステートメントオブジェクトを作成
		...
		lblNewLabel = new JLabel("※★の多い順に表示");
		lblNewLabel.setBounds(754, 265, 116, 13);
